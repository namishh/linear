...
#[poise::command(slash_command, guild_only, prefix_command, aliases("ru"))]
...
// Logout Command
#[poise::command(slash_command, guild_only, prefix_command, aliases("lo"))]
